...
class VilleController extends AbstractController
{
    ...
    #[Route('/ajouter', name: 'app_ville_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/modifier/{id}', name: 'app_ville_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/supprimer/{id}', name: 'app_ville_delete', methods: ['POST'])]
