...
class MatiereController extends AbstractController
{
    ...
    #[Route('/ajouter', name: 'app_matiere_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/modifier/{id}', name: 'app_matiere_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/supprimer/{id}', name: 'app_matiere_delete', methods: ['POST'])]
